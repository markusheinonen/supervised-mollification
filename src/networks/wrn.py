...
class WideResNet(nn.Module):
	def __init__(self, res, depth, num_classes, widen_factor=1, drop_rate=0.0):
		super().__init__()
	...
	def forward(self, x):
		...
		out = F.avg_pool2d(out, 8 * self.scale)
		out = out.view(-1, self.n_channels)
		return self.fc(out)

def WRN40x2(res, num_classes): return WideResNet(res, depth=40, num_classes=num_classes, widen_factor=2)
def WRN40x10(res, num_classes): return WideResNet(res, depth=40, num_classes=num_classes, widen_factor=10)
