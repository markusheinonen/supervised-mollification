...
class CifarResNeXt(nn.Module):
	...
	def __init__(self, res, block, depth, cardinality, base_width, num_classes):
		super().__init__()
		...
		self.classifier = nn.Linear(256 * block.expansion * scale, num_classes)
...
def ResNext29(res, num_classes): return CifarResNeXt(res, ResNeXtBottleneck, 29, cardinality=4, base_width=32, num_classes=num_classes)
